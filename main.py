...
class UserRequest(BaseModel):
    message: str = Field(..., description="User query to LLM")
...
async def sse_endpoint(user_id: int, is_audio: str = "false"):
    ...
    live_events, live_request_queue = await start_agent_session(user_id_str, is_audio == "false")
...
async def send_message_endpoint(user_id: int, request: UserRequest):
